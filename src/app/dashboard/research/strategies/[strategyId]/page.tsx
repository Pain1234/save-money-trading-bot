...
import { displayValue, getResearchErrorMessage } from "@/lib/research-api/client";
...
export default async function ResearchStrategyDetailPage({
  ...
  try {
    ...
    return (
      <div
        data-testid="research-strategy-detail"
        className="space-y-4"
      >
        ...
        <Card padding="sm" className="grid gap-3 text-sm sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="text-text-muted">Kanonische ID</div>
            <div className="font-mono">{strategy.strategy_id}</div>
          </div>
          <div>
        ...
        <Card padding="sm" className="space-y-3">
          ...
          <p className="text-xs text-text-muted">
            Keine Profitabilitätsbehauptung. Werte entsprechen Strategy
            Specification V1 / StrategyParameters.
          </p>
        ...
        <Card padding="sm" className="space-y-3">
          ...
          {strategy.experiments.length === 0 ? (
            <p className="text-sm text-text-muted" data-testid="strategy-experiments-empty">
