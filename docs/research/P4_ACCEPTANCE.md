...
| Documentation complete (this folder) | #147 | this PR |
...
- [x] Dataset manifest from P3 mandatory
- [x] Strategy interface/resolver contract present and pinned (#148)
...
- [x] Atomic and verifiable artifacts
- [x] Versioned metrics schema (#144)
- [x] Mandatory fee/slippage/funding assumptions (#49) — **without** P5 cost-stress gates
- [x] Gross and net results separated
