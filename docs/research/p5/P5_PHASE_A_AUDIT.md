...
| Bootstrap / Monte Carlo | Path helpers in `services/research/bootstrap.py` | Public framework; private runs pending | Use path net-PnL + DD quantiles (#203) | Seed / block / n_sim freeze |
