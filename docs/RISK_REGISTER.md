...
| R-018 | Correlated multi-asset exposure adds no real diversification | Strategie-Overfitting | Medium | Medium | Medium | Correlation matrix in P7 | Independent hypothesis + cluster risk budget; ADR-014 asset profiles | research / risk | open | [#106](https://github.com/Pain1234/save-money-trading-bot/issues/106) |
| R-019 | Dashboard latency masks critical status changes | Monitoring | Medium | High | High | Slow page loads, stale heartbeat not visible | P2.5 performance baseline and production acceptance | dashboard | open | [#95](https://github.com/Pain1234/save-money-trading-bot/issues/95), [#103](https://github.com/Pain1234/save-money-trading-bot/issues/103) |
| R-020 | Growing history tables slow unindexed dashboard queries | Infrastruktur | Medium | Medium | Medium | Rising p95 on table endpoints | P2.5 SQL/index audit with `EXPLAIN ANALYZE` | dashboard / infrastructure | open | [#101](https://github.com/Pain1234/save-money-trading-bot/issues/101) |
| R-021 | Uncontrolled caching shows stale readiness or warnings | Monitoring | Medium | High | High | READY shown while worker degraded | P2.5 documented cache policy with revalidation tests | dashboard | open | [#99](https://github.com/Pain1234/save-money-trading-bot/issues/99) |
...
| R-026 | Monolithic research score overrides failed critical gates or INVALID integrity | Strategie-Overfitting / Governance | Medium | High | High | UI shows green total score while gate FAIL / integrity INVALID | Layered scorecard contract; gates non-compensable; no auto-promotion (ADR-019) | research / dashboard | planned | [#295](https://github.com/Pain1234/save-money-trading-bot/issues/295), [#284](https://github.com/Pain1234/save-money-trading-bot/issues/284) |
| R-027 | Post-hoc regime selection or unfrozen regime bounds hide weak periods | Backtest-Bias | Medium | High | High | Regime taxonomy changed after seeing results; missing worst-regime report | Versioned classifier + freeze before holdout; worst-regime mandatory (#199/#294) | research | planned | [#285](https://github.com/Pain1234/save-money-trading-bot/issues/285), [#294](https://github.com/Pain1234/save-money-trading-bot/issues/294) |
| R-028 | Missing metrics coerced to zero inflate quality or confidence | Backtest-Bias | Medium | Medium | Medium | `0` displayed where data absent | `NOT_AVAILABLE` contract; fail-closed confidence | research / dashboard | planned | [#284](https://github.com/Pain1234/save-money-trading-bot/issues/284), [#288](https://github.com/Pain1234/save-money-trading-bot/issues/288) |
| R-029 | Isolated parameter peak mistaken for robust edge | Strategie-Overfitting | Medium | High | High | Neighbourhood fails while frozen point passes | Parameter-area / plateau analysis; no auto-retune (#247/#290) | research | planned | [#290](https://github.com/Pain1234/save-money-trading-bot/issues/290) |
| R-030 | Transition losses invisible under monthly regime aggregates | Marktrisiko / Research | Medium | Medium | Medium | Stable-regime scores look fine while switch windows bleed | Explicit transition module + worst-transition in global profile | research | planned | [#289](https://github.com/Pain1234/save-money-trading-bot/issues/289) |
| R-031 | Second scorecard/gate registry drifts from ExperimentRegistry truth | Infrastruktur / Governance | Low | High | High | Duplicate stores with conflicting checksums | Architecture forbid in ADR-019; extend #248/#249 only | research | planned | [#291](https://github.com/Pain1234/save-money-trading-bot/issues/291), [#295](https://github.com/Pain1234/save-money-trading-bot/issues/295) |
