...
| R-009 | PostgreSQL data loss without tested backup | Infrastruktur | Low | Critical | Critical | Backup age monitoring | [`docs/runbooks/backup-restore.md`](runbooks/backup-restore.md) - local restore drill 2026-07-14; Railway Pro managed backups not enabled | infrastructure | partial | [#11](https://github.com/Pain1234/save-money-trading-bot/issues/11) |
