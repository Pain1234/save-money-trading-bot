...
- [ ] Backup and restore tested once and documented — runbook drafted (`docs/runbooks/backup-restore.md`); **drill not executed** (Issue #11 open)
...
**Current gap:** Restore drill pending; kill-switch runbook documents Railway worker-stop path (control API disabled in prod).
