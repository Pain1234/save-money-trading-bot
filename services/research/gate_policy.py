"""Versioned gate evaluation policy (Issue #248 / P4.7c).
...
Validation Study (#249) — it does **not** encode the private, human-owned P5
decision rules (see ``docs/research/p5/P5_DECISION_RULES.md``, still "GATES
PROPOSED"; final decision remains #205) and must never be treated as an
automatic substitute for that human sign-off. No live/paper promotion is
performed anywhere in this module or its callers.
"""
